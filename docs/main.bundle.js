...
var HomemenuComponent = (function () {
    function HomemenuComponent(appService) {
        ...
        this.rows = [1, 2];
        this.deals = [
            new __WEBPACK_IMPORTED_MODULE_2__shared_deals_model__["a" /* Deals */]('product1', 2, '/pic/product1'),
            new __WEBPACK_IMPORTED_MODULE_2__shared_deals_model__["a" /* Deals */]('product2', 1, '/pic/product2'),
            new __WEBPACK_IMPORTED_MODULE_2__shared_deals_model__["a" /* Deals */]('product3', 3, '/pic/product3'),
            new __WEBPACK_IMPORTED_MODULE_2__shared_deals_model__["a" /* Deals */]('product4', 4, '/pic/product4'),
            new __WEBPACK_IMPORTED_MODULE_2__shared_deals_model__["a" /* Deals */]('product5', 2, '/pic/product5'),
            new __WEBPACK_IMPORTED_MODULE_2__shared_deals_model__["a" /* Deals */]('product6', 1, '/pic/product6'),
            new __WEBPACK_IMPORTED_MODULE_2__shared_deals_model__["a" /* Deals */]('product7', 3, '/pic/product7'),
            new __WEBPACK_IMPORTED_MODULE_2__shared_deals_model__["a" /* Deals */]('product8', 4, '/pic/product8'),
        ];
        this.tables = [
            new __WEBPACK_IMPORTED_MODULE_3__shared_tables_model__["a" /* Tables */]('product1', 'green', 42, 'unisex, freesize', './pic/product1'),
            new __WEBPACK_IMPORTED_MODULE_3__shared_tables_model__["a" /* Tables */]('product2', 'blue', 39, 'unisex, freesize', './pic/product2'),
        ];
        this.rowNumber = [];
